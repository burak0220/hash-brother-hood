...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-dark-900/95 backdrop-blur-xl border-r border-primary-400/10 flex flex-col z-40">
      {/* Logo */}
      <div className="px-3 pt-4 pb-3 border-b border-primary-400/10">
        <Link href="/dashboard" className="group flex items-center justify-center">
          <div className="relative">
            <div className="absolute -inset-3 bg-gradient-to-r from-primary-400/8 to-primary-400/4 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700" />
            <img src="/logo.svg" alt="HashBrotherHood" className="relative w-[200px] h-auto drop-shadow-[0_0_15px_rgba(0,240,255,0.15)] group-hover:drop-shadow-[0_0_25px_rgba(0,240,255,0.25)] transition-all duration-500" />
          </div>
        </Link>
      </div>
