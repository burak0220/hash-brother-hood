...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
    const variants = {
      primary: 'bg-primary-400 hover:bg-primary-500 text-dark-950 font-bold shadow-[0_0_15px_rgba(0,240,255,0.2)] hover:shadow-[0_0_25px_rgba(0,240,255,0.35)]',
      ...
      outline: 'border border-dark-600 hover:border-primary-400/40 text-dark-200 hover:text-neon-cyan',
    };
    const sizes = {
